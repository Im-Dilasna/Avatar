...
import Avatar.modules.helper_funcs.fun_strings as fun
from Avatar import DEMONS, DRAGONS, dispatcher
from Avatar.modules.disable import DisableAbleCommandHandler, DisableAbleMessageHandler
