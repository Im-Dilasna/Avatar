...
import Avatar.modules.sql.global_bans_sql as sql
from Avatar import (
    DEMONS,
    DEV_USERS,
    DRAGONS,
...
from Avatar.modules.helper_funcs.misc import send_to_list
from Avatar.modules.sql.users_sql import get_user_com_chats
