...
from Avatar import DEV_USERS, OWNER_ID, dispatcher
from Avatar.__main__ import GDPR, STATS
from Avatar.modules.disable import DisableAbleCommandHandler
from Avatar.modules.helper_funcs.alternate import send_action, typing_action
