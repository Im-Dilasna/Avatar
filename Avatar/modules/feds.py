...
import Avatar.modules.sql.feds_sql as sql
from Avatar import DRAGONS, EVENT_LOGS, LOGGER, OWNER_ID, TIGERS, WOLVES, dispatcher
...
from Avatar.modules.helper_funcs.string_handling import markdown_parser
